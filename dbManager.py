...
__doc__ = '提供访问Appointed2的数据库的责增删改查接口'
from orm import ModelMetaclass, Model, TempModelMetaclass, TempModel
from orm import create_pool as _createpool
from orm import destory_pool as _despool
import asyncio
